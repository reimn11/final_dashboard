...
sleep_long <- sleep %>%
  dplyr::select(`Stress Level`, `Sleep Duration`, `Quality of Sleep`, `Sleep Disorder`) %>%
  tidyr::pivot_longer(
...
sleep_bp %>%
  ...
  facet_wrap(~ sleep_measure, scales = "free_y") +
  labs(
    title = "Sleep duration and quality vs systolic blood pressure by BMI category",
